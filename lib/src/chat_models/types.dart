...
class ChatGigaChatOptions extends ChatModelOptions {
  /// Constructs a new ChatGigaChatOptions with the given values
  const ChatGigaChatOptions({
    this.model = 'GigaChat',
    this.temperature,
    this.topP,
    this.n = 1,
  ...
  /// Creates a copy of this ChatGigaChatOptions with the given values
  ChatGigaChatOptions copyWith({
    String? model,
    double? temperature,
    double? topP,
    int? n,
  ...
  bool operator ==(Object other) {
    ...
    return other is ChatGigaChatOptions &&
        other.model == model &&
